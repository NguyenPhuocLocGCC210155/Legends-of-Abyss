...
{
	[Header("Gravity")]
	public float gravityStrength; //Lực xuống (trọng lực) cần thiết cho jumpheight và jumpptimetoapex mong muốn.
	public float gravityScale = 2.6f; //Strength of the player's gravity as a multiplier of gravity (set in ProjectSettings/Physics2D).
										  //Also the value the player's rigidbody2D.gravityScale is set to.
	[Space(5)]
	public float fallGravityMult; //Hệ số nhân với trọng lực của người chơi khi rơi.
	public float maxFallSpeed; //Tốc độ rơi tối đa (vận tốc đầu cuối) của người chơi khi rơi.
	[Space(5)]
    ...
    [Header("Assists")]
	[Range(0.01f, 0.5f)] public float coyoteTime; //Thời gian ân hạn sau khi rơi ra khỏi một nền tảng, nơi bạn vẫn có thể nhảy
